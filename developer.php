...
<div class="row" style="background-image:url(images/code.gif)">
<div class="column" style="text-align:center;color:white;font-family: 'Merienda', cursive;font-size:25px; align:"center";> <img src="images/shweta1.jpg" class="img-circle" alt="Cinque Terre" width="230px" height="230px"><br>
...
<p style="text-align:center;color:white;font-family: 'Merienda', cursive;font-size:25px;">Prof. Rekha Acharya (HOD,SOSS)</p>
<br>
